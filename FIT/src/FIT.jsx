    ...
    >
      ...
      <div className="relative z-20 text-slate-700">
        ...
        <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 overflow-hidden">
          ...
          {/* subtle radial glow */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(79,70,229,0.08),transparent_65%)]" />

          {/* Logo */}
          <img
            src="/FIT.png"
            alt="FIT Logo"
            className="w-[320px] sm:w-[420px] md:w-[520px] mb-10 drop-shadow-[0_0_40px_rgba(79,70,229,0.25)]"
          />
          ...
          <h1 className="
            ...
            font-black
            tracking-tight
            bg-gradient-to-b from-indigo-600 via-violet-600 to-indigo-800
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="mt-16 grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8 transition-all duration-300 hover:border-slate-300 hover:shadow-xl hover:shadow-indigo-500/10 group">
                ...
                <h3 className="text-xl font-bold text-indigo-600 mb-4">Scholarship & Fellowship Support</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8 transition-all duration-300 hover:border-slate-300 hover:shadow-xl hover:shadow-indigo-500/10 group">
                ...
                <h3 className="text-xl font-bold text-indigo-600 mb-4">Industry Programs</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8 transition-all duration-300 hover:border-slate-300 hover:shadow-xl hover:shadow-indigo-500/10 group">
                ...
                <h3 className="text-xl font-bold text-indigo-600 mb-4">Mentorship & Guidance</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8 transition-all duration-300 hover:border-slate-300 hover:shadow-xl hover:shadow-indigo-500/10 group">
                ...
                <h3 className="text-xl font-bold text-indigo-600 mb-4">Skill Development</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8 transition-all duration-300 hover:border-slate-300 hover:shadow-xl hover:shadow-indigo-500/10 group">
                ...
                <h3 className="text-xl font-bold text-indigo-600 mb-4">Leadership & Confidence</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-8 transition-all duration-300 hover:border-slate-300 hover:shadow-xl hover:shadow-indigo-500/10 group">
                ...
                <h3 className="text-xl font-bold text-indigo-600 mb-4">Inclusive Tech Community</h3>
                <p className="text-slate-700 leading-relaxed">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-indigo-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                ...
                <h3 className="text-xl font-bold text-indigo-700 mb-3">Confidence & Leadership</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-violet-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                ...
                <h3 className="text-xl font-bold text-violet-700 mb-3">Global Opportunities</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-purple-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                ...
                <h3 className="text-xl font-bold text-purple-700 mb-3">Mentorship Networks</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-indigo-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                ...
                <h3 className="text-xl font-bold text-indigo-700 mb-3">Industry Alignment</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-violet-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                ...
                <h3 className="text-xl font-bold text-violet-700 mb-3">Campus Innovation</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-purple-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                ...
                <h3 className="text-xl font-bold text-purple-700 mb-3">Lasting Impact</h3>
                <p className="text-slate-700 leading-relaxed">
        ...
        <section
          id="contact"
          className="relative py-24 px-6 bg-gradient-to-b from-indigo-50 via-white to-indigo-50"
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-16 grid md:grid-cols-[1.1fr_1.1fr] gap-12 items-start">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-sm font-semibold tracking-[0.25em] text-indigo-600 uppercase mb-3">
                ...
                <div className="space-y-5 text-sm md:text-base">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="mt-1 flex h-9 w-9 items-center justify-center rounded-full bg-indigo-500/10 text-indigo-600">
                      <svg
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            className="group p-2.5 rounded-full border border-indigo-500/40 bg-indigo-500/10 flex items-center justify-center text-indigo-400 transition-all duration-300 hover:bg-indigo-500/20 hover:text-indigo-300 hover:scale-110 hover:shadow-lg hover:shadow-indigo-500/25"
